...
import { Mic, Activity, ShieldCheck, Database, Zap, Lock, Eye, Globe } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center space-x-8">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-semibold tracking-wide text-foreground">VISOR</span>
          </div>
        ...
        <div className="flex items-center space-x-4">
          <Link href="/dashboard">
            <Button variant="ghost" className="text-sm hidden sm:inline-flex">Open Dashboard</Button>
          </Link>
          <Link href="/analyze">
            <Button variant="primary" className="text-sm bg-foreground text-background hover:bg-foreground/90">
              Start Analysis
            </Button>
          </Link>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10 w-full">
        ...
        >
          <h1 className="text-5xl lg:text-7xl font-light tracking-tight text-foreground leading-[1.1]">
            Understand Every <br />
            <span className="font-medium">Voice Signal.</span>
          </h1>
          <p className="text-lg text-text-secondary max-w-xl font-light leading-relaxed">
            VISOR analyzes voice signals for authenticity, spoofing indicators and communication risk — turning raw audio into actionable security intelligence.
          </p>
        ...
        >
          ...
          <Link href="/analyze" className="group block relative">
            <motion.div 
              ...
              whileTap={{ scale: 0.98 }}
              className="w-80 h-80 rounded-full border border-border/50 bg-surface-primary/30 flex flex-col items-center justify-center relative shadow-[0_0_40px_rgba(0,0,0,0.1)] backdrop-blur-sm cursor-pointer transition-all duration-300 group-hover:border-accent/40 group-hover:bg-surface-secondary/50"
            >
              ...
              <div className="w-20 h-20 rounded-full bg-surface-secondary flex items-center justify-center mb-6 shadow-inner relative z-10 transition-colors duration-300 group-hover:bg-accent/10">
                <Mic className="w-8 h-8 text-text-secondary transition-colors duration-300 group-hover:text-accent" />
              </div>
...
function PipelineSection() {
  ...
  return (
    <section id="platform" className="py-32 border-t border-border/50 bg-background relative">
          ...
          {stages.map((stage, i) => (
            <React.Fragment key={i}>
              <motion.div 
                ...
                className="flex items-center space-x-3 bg-surface-primary border border-border px-6 py-4 rounded-sm shadow-sm w-full max-w-sm"
              >
...
function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-32 border-t border-border/50 bg-surface-primary/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="group p-6 rounded-sm border border-border bg-background transition-colors duration-300 hover:border-text-secondary/50"
            >
          ...
          <div className="flex-1 flex items-center">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="p-8 rounded-sm border border-border bg-surface-primary/30 w-full"
              >
    ...
    <section className="py-32 border-t border-border/50 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          {/* Waveform visual */}
          <div className="rounded-sm border border-border bg-surface-primary/50 p-8 flex items-center justify-center min-h-[400px] relative overflow-hidden">
          ...
          <div className="flex flex-col space-y-4">
            <div className="rounded-sm border border-border bg-surface-primary/20 p-8 flex-1 space-y-8">
              <div>
...
function PhilosophySection() {
  return (
    <section id="security" className="py-32 border-t border-border/50">
...
function CtaSection() {
  return (
    <section className="py-32 border-t border-border/50 bg-surface-primary/10 relative overflow-hidden">
